    ...
    with open(stylesheet_name, 'w') as alarm_stylesheet:
        ...
        while alarm_severity <= ALARM_DISCONNECTED:
            ...
            for row in table:
                ...
                _write_alarm_style(alarm_stylesheet, widget_type_names, is_border_alarm_sensitive,
...
def _write_alarm_style(stylesheet_file, widget_type_names, is_border_alarm_sensitive,
                       is_content_alarm_sensitive, alarm_severity):
    """
    ...
    style_contents = ''.join([selectors, '[alarmSeverity="', str(alarm_severity), '"]'])
