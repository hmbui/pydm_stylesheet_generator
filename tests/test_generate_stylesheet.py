...
from ..generate_stylesheet import produce_alarm_stylesheet
...
def test_produce_alarm_stylesheet():
    ...
    source_file_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "test_data", "alarm_stylesheet.css")
